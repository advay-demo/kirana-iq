function Home() {
  ...
  <div className="flex gap-10 animate-scroll">
    ...
    <img src="/images/store1.jpg" className="h-16 opacity-60 hover:opacity-100 transition" />
    <img src="/images/store2.jpg" className="h-16 opacity-60 hover:opacity-100 transition" />
    <img src="/images/store3.jpg" className="h-16 opacity-60 hover:opacity-100 transition" />
    <img src="/images/store4.jpg" className="h-16 opacity-60 hover:opacity-100 transition" />
